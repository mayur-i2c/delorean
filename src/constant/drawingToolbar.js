const drawingToolbarArr = [
...

  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
        <g>
          <path fillRule="nonzero" d="M6 6h19v-1h-19z" id="Line"></path>
          <path fillRule="nonzero" d="M6 24h19v-1h-19z"></path>
          <path fillRule="nonzero" d="M6 17h17v-1h-17z"></path>
          <path d="M14.5 7l2.5 3h-5z"></path>
          <path d="M14.5 22l2.5-3h-5z"></path>
          <path fillRule="nonzero" d="M14 10v10h1v-10z"></path>
          <path
            fillRule="nonzero"
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
        <path
          fill="none"
          stroke="currentColor"
          d="M3.207 19.793L19.793 3.207a1 1 0 0 1 1.414 0l3.586 3.586a1 1 0 0 1 0 1.414L8.207 24.793a1 1 0 0 1-1.414 0l-3.586-3.586a1 1 0 0 1 0-1.414zM5.5 17.5l2 2m1-5l3 3m0-6l2 2m1-5l3 3m0-6l2 2"
        ></path>
      </svg>
    ),
  },
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
        <g fillRule="evenodd">
          ...
          <path fillRule="nonzero" d="M22 14.5a2.5 2.5 0 0 0-5 0v3h1v-3a1.5 1.5 0 0 1 3 0v.5h1v-.5z"></path>
          <g fillRule="nonzero">
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
        <g>
          <path
            fillRule="nonzero"
            d="M7 13.003v8.994c0 .557.445 1.003.994 1.003h12.012c.547 0 .994-.449.994-1.003v-8.994c0-.557-.445-1.003-.994-1.003h-12.012c-.547 0-.994.449-.994 1.003zm-1 0c0-1.106.895-2.003 1.994-2.003h12.012c1.101 0 1.994.894 1.994 2.003v8.994c0 1.106-.895 2.003-1.994 2.003h-12.012c-1.101 0-1.994-.894-1.994-2.003v-8.994z"
          ></path>
          <path fillRule="nonzero" d="M11 11v-4h-1v4z"></path>
          <path
            fillRule="nonzero"
            d="M10 7c0-2.209 1.791-4 4-4s4 1.791 4 4h-1c0-1.657-1.343-3-3-3s-3 1.343-3 3h-1zm1 0h-1c0-2.209 1.791-4 4-4s4 1.791 4 4h-1c0-1.657-1.343-3-3-3s-3 1.343-3 3z"
          ></path>
          <rect width="2" height="4" rx="1" x="13" y="17"></rect>
        </g>
      </svg>
    ),
  },
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
        <g>
          <path
            fillRule="nonzero"
            d="M4.034 14.18l-.07-.18.07-.18c1.535-3.975 5.645-6.82 9.966-6.82 4.32 0 8.431 2.845 9.966 6.82l.07.18-.07.18c-1.535 3.975-5.646 6.82-9.966 6.82-4.321 0-8.431-2.845-9.966-6.82zm9.966 5.82c3.84 0 7.521-2.503 8.962-6-1.441-3.497-5.122-6-8.962-6-3.841 0-7.521 2.503-8.962 6 1.441 3.497 5.121 6 8.962 6z"
          ></path>
          <path d="M11 14.001c0 1.66 1.341 2.999 3.001 2.999s2.999-1.339 2.999-2.999c0-1.66-1.339-3.001-2.999-3.001-1.66 0-3.001 1.341-3.001 3.001z"></path>
        </g>
      </svg>
    ),
  },
